...
template <>
const block_magic_t
    reql_btree_superblock_t::expected_magic<cluster_version_t::v2_0>::value =
        { { 's', 'u', 'p', 'e' } };

// Versions post-2.1 store version_ts in their metainfo
template <>
const block_magic_t
    reql_btree_superblock_t::expected_magic<cluster_version_t::v2_1>::value =
        { { 's', 'u', 'p', 'f' } };
...
void btree_slice_t::init_real_superblock(real_superblock_t *superblock,
    ...
    sb->magic = reql_btree_superblock_t::expected_magic<cluster_version_t::v2_1>::value;
...
void get_superblock_metainfo(
    ...
    std::vector<char> metainfo;
    {
        ...
        if (data->magic == reql_btree_superblock_t::expected_magic<cluster_version_t::v2_1>::value) {
            *version_out = cluster_version_t::v2_1;
        } else if (data->magic == reql_btree_superblock_t::expected_magic<cluster_version_t::v2_0>::value) {
...
void set_superblock_metainfo(real_superblock_t *superblock,
    ...
    if (version == cluster_version_t::v2_0) {
        data->magic = reql_btree_superblock_t::expected_magic<cluster_version_t::v2_0>::value;
    } else if (version == cluster_version_t::v2_1) {
        data->magic = reql_btree_superblock_t::expected_magic<cluster_version_t::v2_1>::value;
    } else {
