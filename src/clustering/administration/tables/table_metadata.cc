...
RDB_IMPL_SERIALIZABLE_2_SINCE_v2_1(table_config_and_shards_change_t::sindex_create_t,
    name, config);
RDB_IMPL_SERIALIZABLE_1_SINCE_v2_1(table_config_and_shards_change_t::sindex_drop_t,
    name);
RDB_IMPL_SERIALIZABLE_3_SINCE_v2_1(table_config_and_shards_change_t::sindex_rename_t,
