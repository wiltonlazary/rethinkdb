...
ql::datum_t artificial_table_t::write_batched_replace(
    ...
    rcheck_datum(return_write_stamps != return_write_stamps_t::NO,
                 ql::base_exc_t::LOGIC,
                 "Cannot return write stamps for artificial tables.");
...
void artificial_table_t::do_single_update(
        ...
        const std::function<ql::datum_t(ql::datum_t)> &function,
        return_write_stamps_t return_write_stamps,
        return_changes_t return_changes,
        signal_t *interruptor,
