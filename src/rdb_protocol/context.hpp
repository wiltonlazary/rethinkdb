...
enum class return_write_stamps_t { NO = 0, YES = 1 };
ARCHIVE_PRIM_MAKE_RANGED_SERIALIZABLE(
        return_write_stamps_t, int8_t,
        return_write_stamps_t::NO, return_write_stamps_t::YES);
...
public:
    ...
    virtual ql::datum_t write_batched_replace(
        ...
        return_write_stamps_t return_write_stamps,
    ...
    virtual bool write_sync_depending_on_durability(
        ql::env_t *env, durability_requirement_t durability) = 0;
